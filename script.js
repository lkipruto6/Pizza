...
$(document).ready(function () {
    $("#delivery").submit(function () {
        ...
        alert("Dear" + name + " Your order has been processed to " +  location + "Your pizza will arrive at your door post from a registered Deliveryman who will call you at the phone number you've registered below. Thank you for ordering from The PIZZERIA!! ");
        // $(this).get(0).reset();
        //  event.preventDefault();
    });
